...
features_of_interest = ['original_firstorder_10Percentile', 'original_firstorder_Mean', 'original_firstorder_Uniformity', 
...
if st.button('Start Feature Extraction'):
    try:
        ...
        # Add selected features to the session state
